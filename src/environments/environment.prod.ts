export const environment = {
  ...
  bingoInsertSongApiUrl: 'https://api.getgogi.com/api/Bingo/Songs/Insert_NewSong',
  bingoInsertSongsApiUrl: 'https://api.getgogi.com/api/Bingo/Songs/Insert_NewSongs_List',
  bingoArtistTypesApiUrl: 'https://api.getgogi.com/api/Bingo/Lookups/ArtistTypes',
  bingoTempoApiUrl: 'https://api.getgogi.com/api/Bingo/Lookups/Tempo',
  bingoDecadeApiUrl: 'https://api.getgogi.com/api/Bingo/Lookups/Decade',
  bingoEraApiUrl: 'https://api.getgogi.com/api/Bingo/Lookups/Era',
  bingoStreamingEraApiUrl: 'https://api.getgogi.com/api/Bingo/Lookups/StreamingEra',
  bingoDifficultyApiUrl: 'https://api.getgogi.com/api/Bingo/Lookups/Difficulty',
