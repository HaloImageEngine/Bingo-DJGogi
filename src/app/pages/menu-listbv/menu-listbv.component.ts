...
import { MenuBVService } from '../../services/menubv.service';
...
@Component({
  selector: 'app-menu-listbv',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './menu-listbv.component.html',
  styleUrl: './menu-listbv.component.scss'
})
export class MenuListbvComponent implements OnInit {
  private readonly menuService = inject(MenuBVService);
